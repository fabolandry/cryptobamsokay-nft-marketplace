      ...
      <nav className="p-2 shadow-lg bg-fuchsia-200 border-bpy-4 navbar navbar-expand-lg navbar-light">
        <div className="relative flex w-screen">
          ...
          <div className="flex justify-around flex-1 mr-auto">
            <Link href="/">
              <button className="relative px-10 py-2 group">
            ...
            <Link href="/create-nft">
              <button className="relative py-2 px-9 group">
                ...
                <span className="relative text-red-700 group-hover:text-red-100"> Sell NFT </span>
              </button>
            </Link>
            <Link href="/my-nfts">
              <button className="relative py-2 px-9 group">
                ...
                <span className="relative text-cyan-700 group-hover:text-cyan-100">My NFT</span>
              </button>
            </Link>
            <Link href="/dashboard">
              <button className="relative px-6 py-2 group">
                ...
                <span className="relative text-indigo-700 group-hover:text-indigo-100"> Dashboard </span>
              </button>
            </Link>
          </div>
        </div>
